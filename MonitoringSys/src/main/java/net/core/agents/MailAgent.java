...
public class MailAgent {
    ...
    public MailAgent(String username, String password) {
    ...
    public void standartSender(String text, String mailTo){
        ...
        sslSender.send("Сбой в системе", "TLS: Метрика1 вышла за диапазон допустимой величины", "testmailncracker@gmail.com", "anton130794@ya.ru");
    }
}
